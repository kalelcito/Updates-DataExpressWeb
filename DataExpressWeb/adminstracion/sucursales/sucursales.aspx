...
<asp:Content ID="Content2" ContentPlaceHolderID="cpCuerpoSup" runat="server">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False" HeaderText="ACCIÓN">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Si eliminas la sucursal se borraran todos los datos que contenga. Asesúrese que los empleados pertenecientes a esta sucursal sean redirigidos a otra. ¿Desea eliminar el registro?');" CausesValidation="False" CommandName="Delete" Text="Eliminar" CssClass="btn btn-primary btn-sm"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="PA_Busqueda_Sucursales" DeleteCommand="UPDATE Cat_Sucursales SET eliminado='True' WHERE (idSucursal = @idSucursal)" SelectCommandType="StoredProcedure">
        <DeleteParameters>
