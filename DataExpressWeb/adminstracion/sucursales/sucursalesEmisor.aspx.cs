...
// ***********************************************************************
// <copyright file="sucursalesEmisor.aspx.cs" company="DataExpress Latinoamérica">
...
{
    /// <summary>
    /// Class SucursalesEmisor.
    /// </summary>
    /// <seealso cref="System.Web.UI.Page" />
    public partial class SucursalesEmisor : Page
    {
        /// <summary>
        /// The _id editar
        /// </summary>
        ...
        private void Llenarlista(string id = null)
        {
            if (!string.IsNullOrEmpty(id))
            {
                var sql = @"SELECT 
	                            ...
	                            s.pais,
	                            s.codigoPostal,
	                            ISNULL(s.logo, e.logo) AS logo
                            FROM Cat_SucursalesEmisor s
                            LEFT OUTER JOIN Cat_Emisor e ON s.RFC = e.RFCEMI
                ...
                if (dr.Read())
                {
                    ...
                    var bytesDb = dr["logo"];
                    var bytes = bytesDb is DBNull ? new byte[0] : (byte[])dr["logo"];
