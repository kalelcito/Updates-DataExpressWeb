<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="modificarCaja.aspx.cs" Inherits="DataExpressWeb.modificarCaja" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cpCuerpoSup" runat="server">
    ...
    <tr>
        ...
        <td class="style1">
            <asp:DropDownList ID="dllEstab" runat="server" AppendDataBoundItems="True"  CssClass="form-control"
    ...
    <tr>
        ...
        <td class="style1">
            ...
            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" runat="server" TargetControlID="tbPtomi"
FilterType="Numbers">
            </asp:FilteredTextBoxExtender>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ControlToValidate="tbPtomi" ErrorMessage="Campo requerido" Font-Size="XX-Small" 
                ForeColor="Red" ValidationGroup="modificar"></asp:RequiredFieldValidator>
        </td>
        <td>
            &nbsp;</td>
    </tr>
    <tr>
        ...
        <td class="style1">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="form-control"
    ...
    <tr>
        ...
        <td class="style1">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                ...
                Font-Size="XX-Small" ForeColor="Red" ValidationGroup="modificar"></asp:RequiredFieldValidator>
        </td>
        <td>
            &nbsp;</td>
    </tr>
    <tr>
        ...
        <td class="style1">
            <asp:TextBox ID="tbImpresora" runat="server" CssClass="form-control"></asp:TextBox>
        </td>
        <td>
            &nbsp;</td>
    </tr>
    <tr>
        <td class="style3">
            &nbsp;</td>
        <td class="style1">
            <asp:DropDownList ID="ddlImpresora" runat="server" AutoPostBack="True" CssClass="form-control"
                onselectedindexchanged="ddlImpresora_SelectedIndexChanged" >
                <asp:ListItem>Ninguna</asp:ListItem>
            </asp:DropDownList>
           
             <asp:LinkButton ID="Button1" runat="server"  CssClass="btn btn-primary"  onclick="Button1_Click" Text="Verificar" >Verificar</asp:LinkButton>
        </td>
        <td>
            &nbsp;</td>
    </tr>
    <tr>
        ...
        <td class="style1">
           ...
           <asp:LinkButton ID="btnModificar" runat="server"  CssClass="btn btn-primary"  onclick="btAgregar_Click" Text="Actualizar" >Actualizar</asp:LinkButton>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpTitulo" runat="server">
    ...
    Font-Bold="True" Font-Size="Small" ForeColor="Black" >MODIFICAR PUNTO DE EMISIÓN</asp:HyperLink>
    </asp:Content>
