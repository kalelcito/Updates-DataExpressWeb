...
<asp:Content ID="Content2" ContentPlaceHolderID="cpCuerpoSup" runat="server">
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="1" OnActiveStepChanged="Wizard1_ActiveStepChanged"
        ...
        onfinishbuttonclick="FinishButton_Click" CssClass="rootwizard">
        <FinishNavigationTemplate>
            <asp:Button ID="FinishPreviousButton" CssClass="btn btn-xl" runat="server" CausesValidation="False" CommandName="MovePrevious" Text="Anterior" />
            &nbsp;&nbsp;
            <asp:Button ID="FinishButton"  CssClass="btn btn-xl" runat="server" CommandName="MoveComplete" Text="Crear Documento" OnClick="FinishButton_Click"  />
        ...
        <StartNavigationTemplate>
            <asp:Button ID="StartNextButton" runat="server" CommandName="MoveNext" CssClass="btn btn-xl" Text="Siguiente" />
        </StartNavigationTemplate>
        <StepNavigationTemplate>
            <asp:Button ID="StepPreviousButton" runat="server" CausesValidation="False" CommandName="MovePrevious"
                 Text="Anterior" CssClass="btn btn-xl"/>
            <asp:Button ID="StepNextButton" runat="server" CommandName="MoveNext"
                Text="Siguiente" ValidationGroup="Form" CausesValidation="False" CssClass="btn btn-xl"/>
        </StepNavigationTemplate>
        <StepStyle/>
        <WizardSteps>
          ...
          <div class="row">
            <div class="col-md-1">
              <asp:Label ID="lbl_cantidad" runat="server" Text="CANT:" ></asp:Label>
           ...
           <asp:Label ID="lbl_precio" runat="server"  Text="PRECIO:"></asp:Label>
                     <asp:TextBox ID="tbPU" runat="server" AutoPostBack="True"
                         CausesValidation="True" OnTextChanged="tbPU_TextChanged"
             ...
             <div class="col-md-1">
           <asp:Label ID="lbl_descuento" runat="server" Text="DESC.:" ></asp:Label>
             ...
             <div class="col-md-2">
            <asp:Label ID="lbl_iva0" runat="server"  Text="IMPORTE:"></asp:Label>
                     <asp:TextBox ID="tbImporteConcepto" runat="server" CausesValidation="True"
                         ...
                         CssClass="form-control" placeholder="00.00 *">0</asp:TextBox>
              </div>
           </div>
          <div class="row">
            <div class="col-md-7" style="align-content:flex-end">

            </div>
          </div>
                <asp:Button ID="bAgregarImpuesto" runat="server" Text="Agregar" OnClick="bAgregarImpuesto_Click" CssClass="btn btn-xl" ValidationGroup="Deta" />
...
<ItemStyle Width="10%"></ItemStyle>
                        ...
                        <asp:BoundField DataField="codigoAuxiliar" HeaderText="COD. AUX." SortExpres    sion="codigoAuxiliar" />--%>
