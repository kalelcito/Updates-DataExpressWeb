<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="crearNotaCredito.aspx.cs" Inherits="DataExpressWeb.CrearNotaCredito" Async="true" %>
        ...
        function ValidarUuid() {
            ...
            if (selectedValue == "1") {
                ...
                if (uuid == undefined || uuid == "") {
                    ...
                    urlAjax = "./crearNotaCredito.aspx/VerificarExistenciaUuid";
                ...
                if (serie == undefined || serie == "") {
                    ...
                    urlAjax = "./crearNotaCredito.aspx/VerificarExistenciaSerieFolio";
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" align="left">
                                            ...
                                            <div class="row" id="divIvaRet10" runat="server" style="display: none;">
                                                <div class="col-md-6" align="left">
                                                     <% if (Session != null && Session["IDENTEMI"] != null && Session["IDENTEMI"].ToString().Equals("TCA130827M58"))
                                                        { %>
                                                    <asp:CheckBox ID="chkHabilitarIvaRet10" runat="server" Checked="false" size="normal" Enabled="true" Text="I.S.R. Ret" />
                                               
                                                    <% }
                                                        else
                                                        { %>
                                                    <asp:CheckBox ID="CheckBox1" runat="server" Checked="false" size="normal" Enabled="true" Text="I.V.A. Ret" />
                                                    <% } %>
                                                     </div>
                                                <div class="col-md-6" align="left">
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                <asp:DropDownList ID="ddlTipoRelacion" runat="server" CssClass="form-control" Style="text-align: center;">
                                                                    <asp:ListItem Value="01" Text="Nota de crédito de los documentos relacionados"></asp:ListItem>
                                                                    <asp:ListItem Value="02" Text="Nota de débito de los documentos relacionados" Selected="True"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-1">
                     ...
                     <i class="fa fa-plus" aria-hidden="true"></i>
                                    ...
                                    <div class="row" id="divAdicionales">
                                        <div class="col-md-12" style="text-align: left;">
                                            <asp:LinkButton ID="lbPrevisualizar" runat="server" CssClass="btn btn-default" OnClick="lbPrevisualizar_Click" Style="display: none;">Previsualizar Nota</asp:LinkButton>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            <%--<div id="divSinadendasHmpEUM" runat="server" visible="true">
                                <div class="alert alert-info">No existen addendas para el contribuyente emisor</div>
                            </div>--%>
                ...
                <%-- ASDSADSA--%>
                <%--ADENDAS HAMPTON SANMINA--%>
                <div class="modal-body">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            <%-- <div id="divSinadendasHmpSANMINA" runat="server" visible="true">
                                <div class="alert alert-info">No existen addendas para el contribuyente emisor</div>
                            </div>--%>
                ...
                <%-- ASDSADSA--%>
                <%--ADENDAS HAMPTON ANFITRIONES--%>
                <div class="modal-body">
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            <%-- <div id="divSinadendasHmpANF" runat="server" visible="true">
                                <div class="alert alert-info">No existen addendas para el contribuyente emisor</div>
                            </div>--%>
                ...
                <div class="modal-body">
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            <%-- <div id="divSinadendasHmpZF" runat="server" visible="true">
                                <div class="alert alert-info">No existen addendas para el contribuyente emisor</div>
                            </div>--%>
